...
//     public StockFactory(UUID id, String nome, String localizacao, Integer quantidade, LocalDate createdAt, LocalDate lastUpdated){
//         this.id = id;
//         this.nome = nome;
...
//         return new StockDigital(id, nome, quantidade, createdAt, lastUpdated, null);
//     }
